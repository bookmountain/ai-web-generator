  ...
  <div id="chatManagePage">
    ...
    <a-form layout="inline" :model="searchParams" @finish="doSearch">
      <a-form-item label="Message">
        <a-input v-model:value="searchParams.message" placeholder="Message content" />
      </a-form-item>
      ...
      <template #bodyCell="{ column, record }">
        ...
        <template v-else-if="column.key === 'action'">
          <a-space>
            ...
            <a-popconfirm title="Delete this message?" @confirm="deleteMessage(record.id)">
...
const deleteMessage = async (id: number | undefined) => {
  ...
  try {
    // Requires a delete-chat-history API on the backend; wire it here when available.
